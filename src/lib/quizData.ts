...
export const questions: Question[] = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    options: [
      ...
      { value: "prompt_eng", label: "Prompt Engineering (AI)" },
      { value: "langchain", label: "LangChain / LlamaIndex" },
      { value: "genai_apis", label: "GenAI APIs (OpenAI / Gemini / Claude)" },
      { value: "huggingface", label: "Hugging Face Transformers" },
      { value: "none", label: "None yet" },
    ],
    required: true,
    helperText: "Select all you've worked with — pick 'Other' to add your own",
  },
  {
